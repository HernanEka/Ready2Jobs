			...
			<div class="container p-3 mt-2">
				<?php if ($kategori == 'user') { ?>
					...
					<form action="" method="POST" class="col-md-4">
						...
						<div class="my-4">
							<button type="submit" name="user" class="btn btn-primary px-4">Daftar</button>
						</div>
					</form>
				<?php } ?>

				<?php if ($kategori == 'program') { ?>
					<h1 class="display-3">Tambah Data Program</h1>
					<form action="" method="POST" class="col-md-4" enctype="multipart/form-data">
						...
						<div class="my-4">
							...
							<input type="number" name="harga" id="harga" class="form-control" placeholder="Harga Pendaftaran Program">
						</div>
						<div class="my-4">
